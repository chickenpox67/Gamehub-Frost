...
# instance fields
.field public f:Lorg/tukaani/xz/check/Check;
...
.method public a(JJ)V
    ...
    invoke-virtual {p1, p2}, Lorg/tukaani/xz/check/Check;->e([B)V
...
.method public f(Ljava/io/InputStream;)V
    ...
    invoke-static {v2}, Lorg/tukaani/xz/common/DecoderUtil;->f(Ljava/io/InputStream;)J
    ...
    :try_start_0
    invoke-virtual {p1, v7, v8, v9, v10}, Lorg/tukaani/xz/index/IndexHash;->a(JJ)V
    :try_end_0
    .catch Lorg/tukaani/xz/XZIOException; {:try_start_0 .. :try_end_0} :catch_0

    iget-wide v7, p1, Lorg/tukaani/xz/index/IndexBase;->b:J

    iget-wide v9, p0, Lorg/tukaani/xz/index/IndexBase;->b:J

    cmp-long v5, v7, v9

    if-gtz v5, :cond_0

    iget-wide v7, p1, Lorg/tukaani/xz/index/IndexBase;->c:J

    iget-wide v9, p0, Lorg/tukaani/xz/index/IndexBase;->c:J

    cmp-long v5, v7, v9

    if-gtz v5, :cond_0

    iget-wide v7, p1, Lorg/tukaani/xz/index/IndexBase;->d:J

    iget-wide v9, p0, Lorg/tukaani/xz/index/IndexBase;->d:J
    ...
    :cond_1
    iget-wide v3, p1, Lorg/tukaani/xz/index/IndexBase;->b:J

    iget-wide v7, p0, Lorg/tukaani/xz/index/IndexBase;->b:J

    cmp-long v3, v3, v7

    if-nez v3, :cond_6

    iget-wide v3, p1, Lorg/tukaani/xz/index/IndexBase;->c:J

    iget-wide v7, p0, Lorg/tukaani/xz/index/IndexBase;->c:J

    cmp-long v3, v3, v7

    if-nez v3, :cond_6

    iget-wide v3, p1, Lorg/tukaani/xz/index/IndexBase;->d:J

    iget-wide v7, p0, Lorg/tukaani/xz/index/IndexBase;->d:J
    ...
    invoke-virtual {p1}, Lorg/tukaani/xz/check/Check;->a()[B

    move-result-object p1

    iget-object v3, p0, Lorg/tukaani/xz/index/IndexHash;->f:Lorg/tukaani/xz/check/Check;

    invoke-virtual {v3}, Lorg/tukaani/xz/check/Check;->a()[B
