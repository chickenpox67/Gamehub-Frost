...
.field public l:Lorg/conscrypt/NativeRef$EVP_PKEY_CTX;
...
.method public a(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iget-boolean v1, p0, Lorg/conscrypt/OpenSSLCipherRSA;->c:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, Lorg/conscrypt/OpenSSLCipherRSA;->a:Lorg/conscrypt/OpenSSLKey;

    invoke-virtual {v1}, Lorg/conscrypt/OpenSSLKey;->c()Lorg/conscrypt/NativeRef$EVP_PKEY;
    ...
    iput-object v0, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->l:Lorg/conscrypt/NativeRef$EVP_PKEY_CTX;
    ...
    invoke-virtual {p0, p1}, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->g(Ljavax/crypto/spec/OAEPParameterSpec;)V

    :cond_1
    iget-object p1, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->l:Lorg/conscrypt/NativeRef$EVP_PKEY_CTX;

    iget-wide v0, p1, Lorg/conscrypt/NativeRef;->a:J
    ...
    iget-wide v2, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->h:J
    ...
    iget-wide v2, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->j:J

    invoke-static {v0, v1, v2, v3}, Lorg/conscrypt/NativeCrypto;->EVP_PKEY_CTX_set_rsa_mgf1_md(JJ)V

    iget-object p1, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->k:[B
    ...
    iget-object v0, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->l:Lorg/conscrypt/NativeRef$EVP_PKEY_CTX;
...
.method public b([B[B)I
    ...
    iget-boolean v0, p0, Lorg/conscrypt/OpenSSLCipherRSA;->c:Z

    if-eqz v0, :cond_0

    iget-object v1, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->l:Lorg/conscrypt/NativeRef$EVP_PKEY_CTX;
...
.method public c(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    :cond_4
    :goto_1
    invoke-super {p0, p1, p2, p3}, Lorg/conscrypt/OpenSSLCipherRSA;->c(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    invoke-virtual {p0}, Lorg/conscrypt/OpenSSLCipherRSA;->d()Z
    ...
    iget-object v1, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->k:[B
    ...
    iget-object v2, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->k:[B
    ...
    iget-wide v3, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->h:J

    invoke-static {v3, v4}, Lorg/conscrypt/EvpMdRef;->d(J)Ljava/lang/String;
    ...
    iget-wide v6, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->j:J

    invoke-static {v6, v7}, Lorg/conscrypt/EvpMdRef;->d(J)Ljava/lang/String;
...
.method public engineInit(ILjava/security/Key;Ljava/security/AlgorithmParameters;Ljava/security/SecureRandom;)V
    ...
    .line 6
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->c(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
...
.method public engineSetPadding(Ljava/lang/String;)V
    ...
    iput p1, p0, Lorg/conscrypt/OpenSSLCipherRSA;->g:I
...
.method public f()I
    ...
    invoke-virtual {p0}, Lorg/conscrypt/OpenSSLCipherRSA;->e()I

    move-result v0

    iget v1, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->i:I
...
.method public final g(Ljavax/crypto/spec/OAEPParameterSpec;)V
    .locals 5
    ...
    :try_start_0
    invoke-static {v0}, Lorg/conscrypt/EvpMdRef;->b(Ljava/lang/String;)J

    move-result-wide v3

    iput-wide v3, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->h:J

    invoke-static {v0}, Lorg/conscrypt/EvpMdRef;->a(Ljava/lang/String;)I

    move-result v0

    iput v0, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->i:I
    ...
    iput-wide v0, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->j:J
    :try_end_0
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object p1, p0, Lorg/conscrypt/OpenSSLCipherRSA$OAEP;->k:[B
