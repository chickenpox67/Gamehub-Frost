...
.method public write(Lorg/bouncycastle/asn1/ASN1Encodable;Lorg/bouncycastle/oer/Element;)V
    ...
    :cond_0
    instance-of v3, p1, Lorg/bouncycastle/oer/OEROptional;
    ...
    :goto_5
    invoke-virtual {p2, v7}, Lorg/bouncycastle/oer/Element;->appendLabel(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, p2}, Lorg/bouncycastle/oer/Element;->expandDeferredDefinition(Lorg/bouncycastle/oer/Element;Lorg/bouncycastle/oer/Element;)Lorg/bouncycastle/oer/Element;

    move-result-object v1

    invoke-virtual {v1}, Lorg/bouncycastle/oer/Element;->getEnumValue()Ljava/math/BigInteger;
    ...
    invoke-virtual {v3, v2}, Lorg/bouncycastle/oer/BitBuilder;->writeBit(I)Lorg/bouncycastle/oer/BitBuilder;
    ...
    invoke-virtual {v0, v7, v8, v6}, Lorg/bouncycastle/oer/BitBuilder;->writeBits(JI)Lorg/bouncycastle/oer/BitBuilder;
    ...
    :goto_e
    iget-object v5, p0, Lorg/bouncycastle/oer/OEROutputStream;->debugOutput:Ljava/io/PrintWriter;
    ...
    invoke-virtual {p0, v3, p1}, Lorg/bouncycastle/oer/OEROutputStream;->writePlainType(Lorg/bouncycastle/asn1/ASN1Encodable;Lorg/bouncycastle/oer/Element;)V

    goto/16 :goto_0

    :cond_19
    invoke-virtual {p0, v3, p1}, Lorg/bouncycastle/oer/OEROutputStream;->write(Lorg/bouncycastle/asn1/ASN1Encodable;Lorg/bouncycastle/oer/Element;)V
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/oer/Element;->getBaseType()Lorg/bouncycastle/oer/OERDefinition$BaseType;
    ...
    :cond_1e
    invoke-virtual {v5}, Lorg/bouncycastle/oer/Element;->getBlock()I
    ...
    invoke-virtual {v5, v8}, Lorg/bouncycastle/oer/OEROptional;->equals(Ljava/lang/Object;)Z
    ...
    sget-object v5, Lorg/bouncycastle/oer/OEROutputStream;->bits:[I
    ...
    check-cast v9, Lorg/bouncycastle/oer/Element;

    invoke-virtual {v9}, Lorg/bouncycastle/oer/Element;->getBaseType()Lorg/bouncycastle/oer/OERDefinition$BaseType;

    move-result-object v10

    sget-object v11, Lorg/bouncycastle/oer/OERDefinition$BaseType;->EXTENSION:Lorg/bouncycastle/oer/OERDefinition$BaseType;
    ...
    :cond_23
    invoke-virtual {v9}, Lorg/bouncycastle/oer/Element;->getBlock()I
    ...
    :cond_24
    invoke-static {v9, p2}, Lorg/bouncycastle/oer/Element;->expandDeferredDefinition(Lorg/bouncycastle/oer/Element;Lorg/bouncycastle/oer/Element;)Lorg/bouncycastle/oer/Element;
    ...
    new-instance v10, Lorg/bouncycastle/oer/SwitchIndexer$Asn1SequenceIndexer;

    invoke-direct {v10, p1}, Lorg/bouncycastle/oer/SwitchIndexer$Asn1SequenceIndexer;-><init>(Lorg/bouncycastle/asn1/ASN1Sequence;)V

    invoke-interface {v9, v10}, Lorg/bouncycastle/oer/Switch;->result(Lorg/bouncycastle/oer/SwitchIndexer;)Lorg/bouncycastle/oer/Element;
    ...
    iget-object v6, p0, Lorg/bouncycastle/oer/OEROutputStream;->out:Ljava/io/OutputStream;
    ...
    invoke-virtual {v9}, Lorg/bouncycastle/oer/Element;->isExplicit()Z

    move-result v11

    if-eqz v11, :cond_28

    instance-of v11, v10, Lorg/bouncycastle/oer/OEROptional;
    ...
    invoke-virtual {v9}, Lorg/bouncycastle/oer/Element;->getDefaultValue()Lorg/bouncycastle/asn1/ASN1Encodable;

    move-result-object v12

    if-eqz v12, :cond_2a

    instance-of v10, v11, Lorg/bouncycastle/oer/OEROptional;

    if-eqz v10, :cond_29

    check-cast v11, Lorg/bouncycastle/oer/OEROptional;

    invoke-virtual {v11}, Lorg/bouncycastle/oer/OEROptional;->isDefined()Z

    move-result v10

    if-eqz v10, :cond_2b

    invoke-virtual {v11}, Lorg/bouncycastle/oer/OEROptional;->get()Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    sget-object v9, Lorg/bouncycastle/oer/OEROutputStream;->bits:[I
    ...
    :cond_2a
    sget-object v9, Lorg/bouncycastle/oer/OEROptional;->ABSENT:Lorg/bouncycastle/oer/OEROptional;
    ...
    invoke-virtual {v8}, Lorg/bouncycastle/oer/Element;->getaSwitch()Lorg/bouncycastle/oer/Switch;
    ...
    invoke-interface {v8, v10}, Lorg/bouncycastle/oer/Switch;->result(Lorg/bouncycastle/oer/SwitchIndexer;)Lorg/bouncycastle/oer/Element;
    ...
    :cond_32
    invoke-virtual {p0, v9, v8}, Lorg/bouncycastle/oer/OEROutputStream;->write(Lorg/bouncycastle/asn1/ASN1Encodable;Lorg/bouncycastle/oer/Element;)V
    ...
    sget-object v11, Lorg/bouncycastle/oer/OEROptional;->ABSENT:Lorg/bouncycastle/oer/OEROptional;

    invoke-virtual {p1, v8}, Lorg/bouncycastle/asn1/ASN1Sequence;->getObjectAt(I)Lorg/bouncycastle/asn1/ASN1Encodable;

    move-result-object v12

    invoke-virtual {v11, v12}, Lorg/bouncycastle/oer/OEROptional;->equals(Ljava/lang/Object;)Z

    move-result v11

    if-nez v11, :cond_35

    sget-object v11, Lorg/bouncycastle/oer/OEROutputStream;->bits:[I
    ...
    invoke-virtual {p0, v9}, Lorg/bouncycastle/oer/OEROutputStream;->write(I)V
