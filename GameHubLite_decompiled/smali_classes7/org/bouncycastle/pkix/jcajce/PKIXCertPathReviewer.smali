...
.method private checkCriticalExtensions()V
    ...
    const-string v0, "org.bouncycastle.pkix.CertPathReviewerMessages"
    ...
    :cond_1
    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->KEY_USAGE:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->POLICY_MAPPINGS:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->INHIBIT_ANY_POLICY:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->ISSUING_DISTRIBUTION_POINT:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->DELTA_CRL_INDICATOR:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->POLICY_CONSTRAINTS:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->BASIC_CONSTRAINTS:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->SUBJECT_ALTERNATIVE_NAME:Ljava/lang/String;

    invoke-interface {v8, v9}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v9, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->NAME_CONSTRAINTS:Ljava/lang/String;
    ...
    invoke-direct {p0, v7, v2}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->processQcStatements(Ljava/security/cert/X509Certificate;I)Z
    ...
    :try_start_3
    new-instance v7, Lorg/bouncycastle/pkix/util/ErrorBundle;
    ...
    invoke-direct {v7, v0, v8, v4}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v7, v1, v3, v2}, Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException;-><init>(Lorg/bouncycastle/pkix/util/ErrorBundle;Ljava/lang/Throwable;Ljava/security/cert/CertPath;I)V
    ...
    new-instance v8, Lorg/bouncycastle/pkix/util/ErrorBundle;
    ...
    invoke-direct {v8, v0, v9, v10}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0, v8, v2}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    :goto_5
    new-instance v2, Lorg/bouncycastle/pkix/util/ErrorBundle;
    ...
    invoke-direct {v2, v0, v7, v4}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v0, Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException;

    invoke-direct {v0, v2, v1}, Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException;-><init>(Lorg/bouncycastle/pkix/util/ErrorBundle;Ljava/lang/Throwable;)V
    ...
    :goto_6
    invoke-virtual {v0}, Lorg/bouncycastle/pkix/util/LocalizedException;->getErrorMessage()Lorg/bouncycastle/pkix/util/ErrorBundle;
...
.method private checkNameConstraints()V
    ...
    new-instance v0, Lorg/bouncycastle/pkix/PKIXNameConstraintValidator;

    invoke-direct {v0}, Lorg/bouncycastle/pkix/PKIXNameConstraintValidator;-><init>()V
    ...
    invoke-static {v3}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->isSelfIssued(Ljava/security/cert/X509Certificate;)Z

    move-result v4
    :try_end_0
    .catch Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException; {:try_start_0 .. :try_end_0} :catch_0

    const-string v5, "org.bouncycastle.pkix.CertPathReviewerMessages"
    ...
    :try_start_1
    invoke-static {v3}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)Ljavax/security/auth/x500/X500Principal;
    ...
    :try_start_3
    invoke-virtual {v0, v7}, Lorg/bouncycastle/pkix/PKIXNameConstraintValidator;->checkPermittedDN(Lorg/bouncycastle/asn1/ASN1Sequence;)V
    :try_end_3
    .catch Lorg/bouncycastle/pkix/PKIXNameConstraintValidatorException; {:try_start_3 .. :try_end_3} :catch_4
    .catch Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException; {:try_start_3 .. :try_end_3} :catch_0

    :try_start_4
    invoke-virtual {v0, v7}, Lorg/bouncycastle/pkix/PKIXNameConstraintValidator;->checkExcludedDN(Lorg/bouncycastle/asn1/ASN1Sequence;)V
    :try_end_4
    .catch Lorg/bouncycastle/pkix/PKIXNameConstraintValidatorException; {:try_start_4 .. :try_end_4} :catch_3
    .catch Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException; {:try_start_4 .. :try_end_4} :catch_0

    :try_start_5
    sget-object v4, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->SUBJECT_ALTERNATIVE_NAME:Ljava/lang/String;

    invoke-static {v3, v4}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v4

    check-cast v4, Lorg/bouncycastle/asn1/ASN1Sequence;
    :try_end_5
    .catch Lorg/bouncycastle/pkix/jcajce/AnnotatedException; {:try_start_5 .. :try_end_5} :catch_2
    ...
    :try_start_7
    invoke-virtual {v0, v8}, Lorg/bouncycastle/pkix/PKIXNameConstraintValidator;->checkPermitted(Lorg/bouncycastle/asn1/x509/GeneralName;)V

    invoke-virtual {v0, v8}, Lorg/bouncycastle/pkix/PKIXNameConstraintValidator;->checkExcluded(Lorg/bouncycastle/asn1/x509/GeneralName;)V
    :try_end_7
    .catch Lorg/bouncycastle/pkix/PKIXNameConstraintValidatorException; {:try_start_7 .. :try_end_7} :catch_1
    ...
    :try_start_8
    new-instance v3, Lorg/bouncycastle/pkix/util/ErrorBundle;
    ...
    invoke-direct {v3, v5, v4, v2}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v2, v3, v0, v4, v1}, Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException;-><init>(Lorg/bouncycastle/pkix/util/ErrorBundle;Ljava/lang/Throwable;Ljava/security/cert/CertPath;I)V
    ...
    invoke-direct {v2, v5, v3}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v5, v7, v2}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_9
    sget-object v4, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->NAME_CONSTRAINTS:Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lorg/bouncycastle/pkix/PKIXNameConstraintValidator;->intersectPermittedSubtree([Lorg/bouncycastle/asn1/x509/GeneralSubtree;)V
    ...
    invoke-virtual {v0, v4}, Lorg/bouncycastle/pkix/PKIXNameConstraintValidator;->addExcludedSubtree(Lorg/bouncycastle/asn1/x509/GeneralSubtree;)V
...
.method private checkPathLength()V
    ...
    iget-object v4, p0, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->certs:Ljava/util/List;
    ...
    invoke-static {v4}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->isSelfIssued(Ljava/security/cert/X509Certificate;)Z
    ...
    new-instance v5, Lorg/bouncycastle/pkix/util/ErrorBundle;

    const-string v6, "CertPathReviewer.pathLengthExtended"

    invoke-direct {v5, v3, v6}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v5}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;)V
    ...
    :cond_1
    :try_start_0
    sget-object v5, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->BASIC_CONSTRAINTS:Ljava/lang/String;

    invoke-static {v4, v5}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :catch_0
    new-instance v4, Lorg/bouncycastle/pkix/util/ErrorBundle;

    const-string v5, "CertPathReviewer.processLengthConstError"

    invoke-direct {v4, v3, v5}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v4, v1}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    invoke-direct {v0, v3, v2, v1}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private checkPolicy()V
    ...
    const-string v9, "org.bouncycastle.pkix.CertPathReviewerMessages"
    ...
    iget-object v6, v1, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->certs:Ljava/util/List;
    ...
    invoke-static {v6, v3}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getQualifierSet(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    ...
    :try_start_5
    invoke-static {v4, v5, v15, v2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->processCertD1i(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)Z

    move-result v18

    if-nez v18, :cond_4

    invoke-static {v4, v5, v15, v2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->processCertD1ii(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)V
    ...
    invoke-direct {v2, v9, v14}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->isSelfIssued(Ljava/security/cert/X509Certificate;)Z
    ...
    new-instance v11, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;
    ...
    invoke-virtual {v13, v11}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->addChild(Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;)V
    ...
    invoke-virtual {v11}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->hasChildren()Z

    move-result v13

    if-nez v13, :cond_14

    invoke-static {v15, v5, v11}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->removePolicyNode(Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;)Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;
    ...
    sget-object v2, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;
    ...
    invoke-virtual {v11, v0}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->setCritical(Z)V
    ...
    invoke-direct {v0, v9, v2}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_8
    sget-object v0, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->POLICY_MAPPINGS:Ljava/lang/String;

    invoke-static {v6, v0}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :try_start_b
    invoke-static {v4, v5, v3, v2, v6}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->prepareNextCertB1(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    :try_end_b
    ...
    invoke-direct {v0, v9, v14}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v9, v10}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5, v3, v15}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->prepareNextCertB2(I[Ljava/util/List;Ljava/lang/String;Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;)Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;
    ...
    :goto_1e
    :try_start_d
    sget-object v2, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->POLICY_CONSTRAINTS:Ljava/lang/String;

    invoke-static {v6, v2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :cond_2c
    :try_start_e
    sget-object v2, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->INHIBIT_ANY_POLICY:Ljava/lang/String;
    ...
    invoke-direct {v2, v9, v3}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v9, v10}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_30
    :try_start_10
    sget-object v0, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->POLICY_CONSTRAINTS:Ljava/lang/String;

    invoke-static {v4, v0}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-direct {v2, v9, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException;

    iget-object v3, v1, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->certPath:Ljava/security/cert/CertPath;

    invoke-direct {v0, v2, v3, v12}, Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException;-><init>(Lorg/bouncycastle/pkix/util/ErrorBundle;Ljava/security/cert/CertPath;I)V

    throw v0

    :cond_36
    invoke-static/range {v27 .. v27}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->isAnyPolicy(Ljava/util/Set;)Z
    ...
    invoke-virtual {v10}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->getChildren()Ljava/util/Iterator;
    ...
    check-cast v3, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;

    invoke-virtual {v3}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->hasChildren()Z

    move-result v6

    if-nez v6, :cond_3b

    invoke-static {v15, v5, v3}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->removePolicyNode(Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;)Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;
    ...
    check-cast v12, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;

    invoke-virtual {v12}, Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;->getValidPolicy()Ljava/lang/String;
    ...
    invoke-static {v15, v5, v2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->removePolicyNode(Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;)Lorg/bouncycastle/pkix/jcajce/PKIXPolicyNode;
...
.method private checkSignatures()V
    ...
    iget-object v2, v10, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->validDate:Ljava/util/Date;
    ...
    iget-object v3, v10, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->currentDate:Ljava/util/Date;

    invoke-direct {v2, v3}, Lorg/bouncycastle/pkix/util/filter/TrustedInput;-><init>(Ljava/lang/Object;)V

    filled-new-array {v1, v2}, [Ljava/lang/Object;

    move-result-object v1

    const-string v11, "org.bouncycastle.pkix.CertPathReviewerMessages"

    const-string v2, "CertPathReviewer.certPathValidDate"

    invoke-direct {v0, v11, v2, v1}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v0}, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V

    aput-object v1, v3, v13

    invoke-direct {v2, v11, v4, v3}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v10, v2}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;)V
    ...
    new-instance v1, Lorg/bouncycastle/pkix/util/ErrorBundle;
    ...
    invoke-direct {v4, v0}, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v11, v2, v3}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v11, v2}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v11, v3, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :try_start_4
    invoke-static {v0}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getSubjectPrincipal(Ljava/security/cert/X509Certificate;)Ljavax/security/auth/x500/X500Principal;
    ...
    invoke-direct {v1, v11, v3, v2}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_8
    :try_start_5
    invoke-static {v2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getAlgorithmIdentifier(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    invoke-direct {v3, v11, v4}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v7, v0}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->verifyX509Certificate(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_6
    ...
    invoke-direct {v2, v11, v1, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :goto_b
    invoke-virtual {v10, v2, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    invoke-static {v3, v0, v2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->verifyX509Certificate(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v0, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    :try_end_7
    ...
    invoke-direct {v0, v11, v1}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v11, v2}, Lorg/bouncycastle/pkix/util/LocaleString;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v2, Lorg/bouncycastle/pkix/util/LocaleString;

    const-string v9, "missingSerial"

    invoke-direct {v2, v11, v9}, Lorg/bouncycastle/pkix/util/LocaleString;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lorg/bouncycastle/pkix/util/LocalizedMessage;->setExtraArguments([Ljava/lang/Object;)V
    ...
    invoke-static {v3, v0}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v3, v1}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-direct {v1, v11, v2}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v10, v1, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    invoke-direct {v14, v12}, Lorg/bouncycastle/pkix/util/filter/UntrustedUrlInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v2, v11, v14, v12}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v10, v2, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    iget-object v12, v10, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->validDate:Ljava/util/Date;
    :try_end_b
    ...
    invoke-virtual {v10, v0, v12}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    invoke-direct {v1, v11, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v10, v1, v12}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    :goto_15
    :try_start_d
    sget-object v1, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->BASIC_CONSTRAINTS:Ljava/lang/String;

    invoke-static {v14, v1}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v0, v12}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getNextWorkingKey(Ljava/util/List;I)Ljava/security/PublicKey;
    ...
    :try_start_f
    invoke-static {v7}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getAlgorithmIdentifier(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    iput-object v1, v10, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->trustAnchor:Ljava/security/cert/TrustAnchor;
...
.method private getCRL(Ljava/lang/String;)Ljava/security/cert/X509CRL;
    ...
    invoke-direct {v2, p1}, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v0, v2, p1}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance p1, Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException;

    invoke-direct {p1, v1}, Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException;-><init>(Lorg/bouncycastle/pkix/util/ErrorBundle;)V
...
.method private processQcStatements(Ljava/security/cert/X509Certificate;I)Z
    ...
    const-string v2, "org.bouncycastle.pkix.CertPathReviewerMessages"
    ...
    invoke-static {v5, v4}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-direct {v7, v2, v8}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    invoke-virtual {v0, v7, v1}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    invoke-direct {v8, v2, v13, v9}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_2
    invoke-virtual {v0, v8, v1}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V

    goto :goto_3

    :cond_4
    new-instance v6, Lorg/bouncycastle/pkix/util/ErrorBundle;
    ...
    invoke-direct {v10, v7}, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V

    const/4 v7, 0x1

    aput-object v10, v9, v7

    invoke-direct {v6, v2, v8, v9}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v0, v6, v1}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    :try_end_0
    .catch Lorg/bouncycastle/pkix/jcajce/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v4, v2, v5}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0, v4, v1}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
...
# virtual methods
.method public addError(Lorg/bouncycastle/pkix/util/ErrorBundle;)V
    .locals 2
...
.method public addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    .locals 1
...
.method public addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;)V
    .locals 2
...
.method public addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    .locals 1
...
.method public checkCRLs(Ljava/security/cert/PKIXParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Vector;I)V
    ...
    :try_start_0
    invoke-static/range {p2 .. p2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    ...
    new-instance v15, Lorg/bouncycastle/pkix/jcajce/X509CRLStoreSelector;

    invoke-direct {v15}, Lorg/bouncycastle/pkix/jcajce/X509CRLStoreSelector;-><init>()V

    invoke-static {v15, v2}, Lorg/bouncycastle/pkix/jcajce/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/pkix/jcajce/X509CRLStoreSelector;Ljava/security/cert/PKIXParameters;)Ljava/util/Set;
    ...
    new-instance v15, Lorg/bouncycastle/pkix/util/ErrorBundle;

    const-string v13, "CertPathReviewer.noCrlInCertstore"

    new-array v3, v12, [Ljava/lang/Object;

    new-instance v12, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;

    invoke-virtual {v0}, Ljava/security/cert/X509CRLSelector;->getIssuerNames()Ljava/util/Collection;

    move-result-object v0

    invoke-direct {v12, v0}, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v11}, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v15, v10, v13, v3}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v1, v15, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    :try_end_1
    ...
    invoke-direct {v3, v10, v9, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v1, v3, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addError(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    :cond_2
    new-instance v12, Lorg/bouncycastle/pkix/util/ErrorBundle;

    const-string v13, "CertPathReviewer.localInvalidCRL"

    invoke-direct {v12, v10, v13, v11}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance v13, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;

    invoke-virtual {v3}, Ljavax/security/auth/x500/X500Principal;->getName()Ljava/lang/String;

    move-result-object v3

    invoke-direct {v13, v3}, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v13}, Lorg/bouncycastle/pkix/util/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V

    const/4 v13, 0x1

    aput-object v3, v14, v13

    new-instance v3, Lorg/bouncycastle/pkix/util/filter/UntrustedUrlInput;

    invoke-direct {v3, v0}, Lorg/bouncycastle/pkix/util/filter/UntrustedUrlInput;-><init>(Ljava/lang/Object;)V

    const/4 v13, 0x2

    aput-object v3, v14, v13

    invoke-direct {v15, v10, v11, v14}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v13, v3}, Lorg/bouncycastle/pkix/util/filter/TrustedInput;-><init>(Ljava/lang/Object;)V
    :try_end_5
    .catch Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException; {:try_start_5 .. :try_end_5} :catch_8
    ...
    invoke-direct {v13, v11}, Lorg/bouncycastle/pkix/util/filter/TrustedInput;-><init>(Ljava/lang/Object;)V
    :try_end_6
    .catch Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException; {:try_start_6 .. :try_end_6} :catch_7
    ...
    invoke-direct {v13, v0}, Lorg/bouncycastle/pkix/util/filter/UntrustedUrlInput;-><init>(Ljava/lang/Object;)V
    :try_end_7
    ...
    invoke-direct {v0, v10, v11, v14}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :try_end_8
    .catch Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException; {:try_start_8 .. :try_end_8} :catch_4
    ...
    invoke-virtual {v1, v0, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    :try_end_9
    .catch Lorg/bouncycastle/pkix/jcajce/CertPathReviewerException; {:try_start_9 .. :try_end_9} :catch_5
    ...
    invoke-direct {v0, v10, v2}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    move-result-object v3
    :try_end_b
    .catch Lorg/bouncycastle/pkix/jcajce/AnnotatedException; {:try_start_b .. :try_end_b} :catch_9

    if-eqz v3, :cond_d

    sget-object v5, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->crlReasons:[Ljava/lang/String;
    ...
    invoke-direct {v2, v10, v3}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v3, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->crlReasons:[Ljava/lang/String;
    ...
    invoke-direct {v5, v10, v3}, Lorg/bouncycastle/pkix/util/LocaleString;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v12, v0}, Lorg/bouncycastle/pkix/util/filter/TrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v10, v5, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v1, v3, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V
    ...
    new-instance v3, Lorg/bouncycastle/pkix/util/filter/TrustedInput;

    invoke-virtual {v0}, Ljava/security/cert/X509CRLEntry;->getRevocationDate()Ljava/util/Date;

    move-result-object v0

    invoke-direct {v3, v0}, Lorg/bouncycastle/pkix/util/filter/TrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v2, v10, v3, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v10, v3}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v10, v4, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v1, v3, v6}, Lorg/bouncycastle/pkix/jcajce/PKIXCertPathReviewer;->addNotification(Lorg/bouncycastle/pkix/util/ErrorBundle;I)V

    :cond_11
    :try_start_c
    sget-object v0, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->ISSUING_DISTRIBUTION_POINT:Ljava/lang/String;

    invoke-static {v11, v0}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v0
    :try_end_c
    .catch Lorg/bouncycastle/pkix/jcajce/AnnotatedException; {:try_start_c .. :try_end_c} :catch_10

    :try_start_d
    sget-object v3, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->DELTA_CRL_INDICATOR:Ljava/lang/String;

    invoke-static {v11, v3}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v3
    :try_end_d
    .catch Lorg/bouncycastle/pkix/jcajce/AnnotatedException; {:try_start_d .. :try_end_d} :catch_f
    ...
    :try_start_e
    invoke-static {v11}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getIssuerPrincipal(Ljava/security/cert/X509CRL;)Ljavax/security/auth/x500/X500Principal;
    ...
    :try_start_f
    sget-object v3, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->CRL_NUMBER:Ljava/lang/String;
    ...
    :try_start_10
    invoke-static {v4, v2}, Lorg/bouncycastle/pkix/jcajce/PKIXCRLUtil;->findCRLs(Lorg/bouncycastle/pkix/jcajce/X509CRLStoreSelector;Ljava/security/cert/PKIXParameters;)Ljava/util/Set;
    ...
    move-result-object v2
    :try_end_10
    .catch Lorg/bouncycastle/pkix/jcajce/AnnotatedException; {:try_start_10 .. :try_end_10} :catch_b
    ...
    :try_start_11
    sget-object v4, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->ISSUING_DISTRIBUTION_POINT:Ljava/lang/String;

    invoke-static {v3, v4}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v3
    :try_end_11
    .catch Lorg/bouncycastle/pkix/jcajce/AnnotatedException; {:try_start_11 .. :try_end_11} :catch_a
    ...
    invoke-direct {v2, v10, v8}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v10, v9}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v10, v7}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_12
    sget-object v2, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->BASIC_CONSTRAINTS:Ljava/lang/String;

    move-object/from16 v3, p2

    invoke-static {v3, v2}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    move-result-object v2
    :try_end_12
    .catch Lorg/bouncycastle/pkix/jcajce/AnnotatedException; {:try_start_12 .. :try_end_12} :catch_e
    ...
    invoke-direct {v0, v10, v8}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getTrustAnchors(Ljava/security/cert/X509Certificate;Ljava/util/Set;)Ljava/util/Collection;
    ...
    :try_start_0
    invoke-static {p1}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    ...
    :catch_0
    new-instance p1, Lorg/bouncycastle/pkix/util/ErrorBundle;

    const-string p2, "org.bouncycastle.pkix.CertPathReviewerMessages"

    const-string v0, "CertPathReviewer.trustAnchorIssuerError"

    invoke-direct {p1, p2, v0}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public init(Ljava/security/cert/CertPath;Ljava/security/cert/PKIXParameters;)V
    ...
    invoke-static {p2, p1}, Lorg/bouncycastle/pkix/jcajce/CertPathValidatorUtilities;->getValidityDate(Ljava/security/cert/PKIXParameters;Ljava/util/Date;)Ljava/util/Date;
    ...
    new-instance p2, Lorg/bouncycastle/pkix/util/ErrorBundle;

    const-string v0, "org.bouncycastle.pkix.CertPathReviewerMessages"

    const-string v1, "CertPathReviewer.emptyCertPath"

    invoke-direct {p2, v0, v1}, Lorg/bouncycastle/pkix/util/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
