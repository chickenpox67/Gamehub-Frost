...
.method private setIso7816CertificateBody(Lorg/bouncycastle/asn1/ASN1TaggedObject;)V
    ...
    invoke-direct {p0, v3}, Lorg/bouncycastle/asn1/eac/CertificateBody;->setCertificateEffectiveDate(Lorg/bouncycastle/asn1/ASN1TaggedObject;)V
    ...
    :cond_1
    invoke-direct {p0, v3}, Lorg/bouncycastle/asn1/eac/CertificateBody;->setCertificateExpirationDate(Lorg/bouncycastle/asn1/ASN1TaggedObject;)V

    goto :goto_0

    :cond_2
    new-instance v4, Lorg/bouncycastle/asn1/eac/CertificateHolderAuthorization;

    invoke-direct {v4, v3}, Lorg/bouncycastle/asn1/eac/CertificateHolderAuthorization;-><init>(Lorg/bouncycastle/asn1/ASN1TaggedObject;)V

    invoke-direct {p0, v4}, Lorg/bouncycastle/asn1/eac/CertificateBody;->setCertificateHolderAuthorization(Lorg/bouncycastle/asn1/eac/CertificateHolderAuthorization;)V

    goto :goto_0

    :cond_3
    invoke-virtual {v3, v0, v2}, Lorg/bouncycastle/asn1/ASN1TaggedObject;->getBaseUniversal(ZI)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v3

    invoke-static {v3}, Lorg/bouncycastle/asn1/eac/PublicKeyDataObject;->getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/eac/PublicKeyDataObject;

    move-result-object v3

    invoke-direct {p0, v3}, Lorg/bouncycastle/asn1/eac/CertificateBody;->setPublicKey(Lorg/bouncycastle/asn1/eac/PublicKeyDataObject;)V

    goto :goto_0

    :cond_4
    invoke-direct {p0, v3}, Lorg/bouncycastle/asn1/eac/CertificateBody;->setCertificateProfileIdentifier(Lorg/bouncycastle/asn1/ASN1TaggedObject;)V

    goto :goto_0

    :cond_5
    invoke-direct {p0, v3}, Lorg/bouncycastle/asn1/eac/CertificateBody;->setCertificateHolderReference(Lorg/bouncycastle/asn1/ASN1TaggedObject;)V

    goto :goto_0

    :cond_6
    invoke-direct {p0, v3}, Lorg/bouncycastle/asn1/eac/CertificateBody;->setCertificationAuthorityReference(Lorg/bouncycastle/asn1/ASN1TaggedObject;)V
