.class Lcom/xj/standalone/steam/data/db/SteamDB_Impl$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/xj/standalone/steam/data/db/SteamDB_Impl;->createOpenDelegate()Landroidx/room/RoomOpenDelegate;
.end annotation
...
# instance fields
.field public final synthetic a:Lcom/xj/standalone/steam/data/db/SteamDB_Impl;


# direct methods
.method public constructor <init>(Lcom/xj/standalone/steam/data/db/SteamDB_Impl;ILjava/lang/String;Ljava/lang/String;)V
    .locals 0

    iput-object p1, p0, Lcom/xj/standalone/steam/data/db/SteamDB_Impl$1;->a:Lcom/xj/standalone/steam/data/db/SteamDB_Impl;
...
.method public createAllTables(Landroidx/sqlite/SQLiteConnection;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `steam_account` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `steam_id` INTEGER NOT NULL DEFAULT 0, `account_name` TEXT NOT NULL DEFAULT \'\', `refresh_token` TEXT DEFAULT \'\', `access_token` TEXT DEFAULT \'\', `new_guard_data` TEXT DEFAULT \'\', `personal_name` TEXT DEFAULT \'\', `avatar_url` TEXT DEFAULT \'\', `is_current_user` INTEGER NOT NULL DEFAULT 0, `is_remember` INTEGER NOT NULL DEFAULT 0, `modify_time` INTEGER NOT NULL, `extra_maps` TEXT NOT NULL DEFAULT \'\')"
    ...
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'44e473a979c13eb6fed9ffdba9a2dc64\')"
...
.method public dropAllTables(Landroidx/sqlite/SQLiteConnection;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `t_steam_user_games`"
...
.method public onOpen(Landroidx/sqlite/SQLiteConnection;)V
    ...
    iget-object v0, p0, Lcom/xj/standalone/steam/data/db/SteamDB_Impl$1;->a:Lcom/xj/standalone/steam/data/db/SteamDB_Impl;

    invoke-static {v0, p1}, Lcom/xj/standalone/steam/data/db/SteamDB_Impl;->v(Lcom/xj/standalone/steam/data/db/SteamDB_Impl;Landroidx/sqlite/SQLiteConnection;)V
...
.method public onValidateSchema(Landroidx/sqlite/SQLiteConnection;)Landroidx/room/RoomOpenDelegate$ValidationResult;
    ...
    const-string v4, "new_guard_data"
    ...
    const-string v6, "is_current_user"
    ...
    const-string v3, "steam_account(com.xj.standalone.steam.data.db.tables.SteamUserTable).\n Expected:\n"
    ...
    const-string v10, "t_steam_user_games"
    ...
    invoke-static {v0, v10}, Landroidx/room/util/TableInfo;->a(Landroidx/sqlite/SQLiteConnection;Ljava/lang/String;)Landroidx/room/util/TableInfo;
    ...
    const-string v3, "t_steam_user_games(com.xj.standalone.steam.data.db.tables.SteamUserGameTable).\n Expected:\n"
    ...
    const-string v10, "steam_account"
    ...
    const-string v8, "last_modify_time"
    ...
    const-string v3, "steam_download_entity(com.xj.standalone.steam.data.bean.SteamModuleDownloadEntity).\n Expected:\n"
    ...
    invoke-direct {v1, v5, v0}, Landroidx/room/RoomOpenDelegate$ValidationResult;-><init>(ZLjava/lang/String;)V
