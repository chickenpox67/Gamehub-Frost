.class public Lcom/xj/mapping/bean/skins/PSSkin;
...
.method public getBigIcon(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p1, Lcom/xj/mapping/R$drawable;->ps_round:I

    goto :goto_0

    :cond_1
    sget p1, Lcom/xj/mapping/R$drawable;->ps_triangle:I

    goto :goto_0

    :cond_2
    sget p1, Lcom/xj/mapping/R$drawable;->ps_x:I

    goto :goto_0

    :cond_3
    sget p1, Lcom/xj/mapping/R$drawable;->ps_square:I
...
.method public getMiniIcon(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xj/mapping/bean/skins/PSSkin;->getBigIcon(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method public getSpIcon(Landroid/content/Context;II)Landroid/graphics/Bitmap;
    ...
    sget v2, Lcom/xj/mapping/R$drawable;->ps_round_sp:I
    ...
    sget v2, Lcom/xj/mapping/R$drawable;->ps_triangle_sp:I
    ...
    sget v2, Lcom/xj/mapping/R$drawable;->ps_x_sp:I
    ...
    sget v2, Lcom/xj/mapping/R$drawable;->ps_square_sp:I
