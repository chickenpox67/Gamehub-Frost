...
.method public static final B(Lkotlin/io/FilePathComponents;)Lkotlin/io/FilePathComponents;
    .locals 2
    ...
    invoke-static {p0}, Lkotlin/io/FilesKt__UtilsKt;->A(Ljava/util/List;)Ljava/util/List;
...
.method public static C(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p0, p1}, Lkotlin/io/FilesKt__UtilsKt;->F(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
...
.method public static final D(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p1}, Lkotlin/io/FilesKt__FilePathComponentsKt;->b(Ljava/io/File;)Z
    ...
    invoke-static {p0, v0, v3, v1, v2}, Lkotlin/text/StringsKt;->f0(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static E(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v0}, Lkotlin/io/FilesKt__UtilsKt;->D(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
...
.method public static final F(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lkotlin/io/FilesKt__UtilsKt;->G(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
...
.method public static final G(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lkotlin/io/FilesKt__FilePathComponentsKt;->c(Ljava/io/File;)Lkotlin/io/FilePathComponents;

    move-result-object v0

    invoke-static {v0}, Lkotlin/io/FilesKt__UtilsKt;->B(Lkotlin/io/FilePathComponents;)Lkotlin/io/FilePathComponents;

    move-result-object v0

    invoke-static/range {p1 .. p1}, Lkotlin/io/FilesKt__FilePathComponentsKt;->c(Ljava/io/File;)Lkotlin/io/FilePathComponents;

    move-result-object v1

    invoke-static {v1}, Lkotlin/io/FilesKt__UtilsKt;->B(Lkotlin/io/FilePathComponents;)Lkotlin/io/FilePathComponents;
    ...
    invoke-static {v0, v6}, Lkotlin/collections/CollectionsKt;->b0(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-static/range {v7 .. v16}, Lkotlin/collections/CollectionsKt;->o0(Ljava/lang/Iterable;Ljava/lang/Appendable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)Ljava/lang/Appendable;
...
.method public static synthetic u(Ljava/io/File;Ljava/io/File;ZIILjava/lang/Object;)Ljava/io/File;
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lkotlin/io/FilesKt__UtilsKt;->t(Ljava/io/File;Ljava/io/File;ZI)Ljava/io/File;
...
.method public static v(Ljava/io/File;)Z
    ...
    invoke-static {p0}, Lkotlin/io/FilesKt__FileTreeWalkKt;->r(Ljava/io/File;)Lkotlin/io/FileTreeWalk;
...
.method public static final w(Ljava/io/File;Ljava/io/File;)Z
    ...
    invoke-static {p0}, Lkotlin/io/FilesKt__FilePathComponentsKt;->c(Ljava/io/File;)Lkotlin/io/FilePathComponents;

    move-result-object v0

    invoke-static {p1}, Lkotlin/io/FilesKt__FilePathComponentsKt;->c(Ljava/io/File;)Lkotlin/io/FilePathComponents;

    move-result-object v1

    invoke-virtual {v1}, Lkotlin/io/FilePathComponents;->d()Z
...
.method public static z(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v0, v1, v0}, Lkotlin/text/StringsKt;->t1(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
