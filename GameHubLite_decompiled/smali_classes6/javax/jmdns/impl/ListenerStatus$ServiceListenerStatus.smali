...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljavax/jmdns/impl/ListenerStatus$ServiceListenerStatus;->d:Lorg/slf4j/Logger;
...
.method public constructor <init>(Ljavax/jmdns/ServiceListener;Z)V
    ...
    iput-object p1, p0, Ljavax/jmdns/impl/ListenerStatus$ServiceListenerStatus;->c:Ljava/util/concurrent/ConcurrentMap;

    return-void
.end method

.method public static final c(Ljavax/jmdns/ServiceInfo;Ljavax/jmdns/ServiceInfo;)Z
    .locals 6
    ...
    :cond_2
    invoke-virtual {p0}, Ljavax/jmdns/ServiceInfo;->o()[B
    ...
    :cond_5
    invoke-virtual {p0, p1}, Ljavax/jmdns/ServiceInfo;->s(Ljavax/jmdns/ServiceInfo;)Z
...
.method public d(Ljavax/jmdns/ServiceEvent;)V
    ...
    iget-object v1, p0, Ljavax/jmdns/impl/ListenerStatus$ServiceListenerStatus;->c:Ljava/util/concurrent/ConcurrentMap;

    invoke-virtual {p1}, Ljavax/jmdns/ServiceEvent;->getInfo()Ljavax/jmdns/ServiceInfo;

    move-result-object v2

    invoke-virtual {v2}, Ljavax/jmdns/ServiceInfo;->b()Ljavax/jmdns/ServiceInfo;
    ...
    invoke-virtual {p0}, Ljavax/jmdns/impl/ListenerStatus;->a()Ljava/util/EventListener;

    move-result-object v0

    check-cast v0, Ljavax/jmdns/ServiceListener;

    invoke-interface {v0, p1}, Ljavax/jmdns/ServiceListener;->d(Ljavax/jmdns/ServiceEvent;)V
    ...
    invoke-interface {v0, p1}, Ljavax/jmdns/ServiceListener;->f(Ljavax/jmdns/ServiceEvent;)V

    goto :goto_0

    :cond_0
    sget-object v0, Ljavax/jmdns/impl/ListenerStatus$ServiceListenerStatus;->d:Lorg/slf4j/Logger;
...
.method public e(Ljavax/jmdns/ServiceEvent;)V
    .locals 3
    ...
    invoke-interface {v0, p1}, Ljavax/jmdns/ServiceListener;->a(Ljavax/jmdns/ServiceEvent;)V
...
.method public declared-synchronized f(Ljavax/jmdns/ServiceEvent;)V
    .locals 4
    ...
    iget-object v2, p0, Ljavax/jmdns/impl/ListenerStatus$ServiceListenerStatus;->c:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-static {v0, v2}, Ljavax/jmdns/impl/ListenerStatus$ServiceListenerStatus;->c(Ljavax/jmdns/ServiceInfo;Ljavax/jmdns/ServiceInfo;)Z
    ...
    invoke-virtual {v0}, Ljavax/jmdns/ServiceInfo;->b()Ljavax/jmdns/ServiceInfo;
    ...
    :cond_0
    iget-object v3, p0, Ljavax/jmdns/impl/ListenerStatus$ServiceListenerStatus;->c:Ljava/util/concurrent/ConcurrentMap;
