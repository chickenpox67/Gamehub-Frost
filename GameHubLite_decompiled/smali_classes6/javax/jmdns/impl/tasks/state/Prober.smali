...
.method public j(Ljavax/jmdns/impl/DNSOutgoing;)Ljavax/jmdns/impl/DNSOutgoing;
    ...
    invoke-virtual {p1, v0}, Ljavax/jmdns/impl/DNSOutgoing;->A(Ljavax/jmdns/impl/DNSQuestion;)V
    ...
    invoke-virtual {p0, p1, v1}, Ljavax/jmdns/impl/tasks/DNSTask;->c(Ljavax/jmdns/impl/DNSOutgoing;Ljavax/jmdns/impl/DNSRecord;)Ljavax/jmdns/impl/DNSOutgoing;
...
.method public k(Ljavax/jmdns/impl/ServiceInfoImpl;Ljavax/jmdns/impl/DNSOutgoing;)Ljavax/jmdns/impl/DNSOutgoing;
    ...
    invoke-static {v0, v1, v4, v2}, Ljavax/jmdns/impl/DNSQuestion;->D(Ljava/lang/String;Ljavax/jmdns/impl/constants/DNSRecordType;Ljavax/jmdns/impl/constants/DNSRecordClass;Z)Ljavax/jmdns/impl/DNSQuestion;

    move-result-object v0

    invoke-virtual {p0, p2, v0}, Ljavax/jmdns/impl/tasks/DNSTask;->d(Ljavax/jmdns/impl/DNSOutgoing;Ljavax/jmdns/impl/DNSQuestion;)Ljavax/jmdns/impl/DNSOutgoing;
    ...
    invoke-virtual {p1}, Ljavax/jmdns/impl/ServiceInfoImpl;->j()I

    move-result v7

    invoke-virtual {p1}, Ljavax/jmdns/impl/ServiceInfoImpl;->q()I
    ...
    invoke-virtual {p0, p2, v0}, Ljavax/jmdns/impl/tasks/DNSTask;->c(Ljavax/jmdns/impl/DNSOutgoing;Ljavax/jmdns/impl/DNSRecord;)Ljavax/jmdns/impl/DNSOutgoing;
...
.method public u(Ljava/util/Timer;)V
    ...
    invoke-virtual {v2}, Ljavax/jmdns/impl/JmDNSImpl;->B1()J
    ...
    invoke-virtual {v4}, Ljavax/jmdns/impl/JmDNSImpl;->J1()I

    move-result v4

    add-int/2addr v4, v3

    invoke-virtual {v2, v4}, Ljavax/jmdns/impl/JmDNSImpl;->l2(I)V
    ...
    invoke-virtual {v2, v3}, Ljavax/jmdns/impl/JmDNSImpl;->l2(I)V
    ...
    invoke-virtual {v2, v0, v1}, Ljavax/jmdns/impl/JmDNSImpl;->k2(J)V

    invoke-virtual {p0}, Ljavax/jmdns/impl/tasks/DNSTask;->e()Ljavax/jmdns/impl/JmDNSImpl;

    move-result-object v0

    invoke-virtual {v0}, Ljavax/jmdns/impl/JmDNSImpl;->Q1()Z
    ...
    invoke-virtual {v0}, Ljavax/jmdns/impl/JmDNSImpl;->J1()I
