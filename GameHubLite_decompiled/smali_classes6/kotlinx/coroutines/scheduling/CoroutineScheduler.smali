...
.method public static synthetic A0(Lkotlinx/coroutines/scheduling/CoroutineScheduler;JILjava/lang/Object;)Z
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->z0(J)Z
...
.method public static synthetic B(Lkotlinx/coroutines/scheduling/CoroutineScheduler;Ljava/lang/Runnable;ZZILjava/lang/Object;)V
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->r(Ljava/lang/Runnable;ZZ)V
...
.method public final L0()Z
    ...
    :cond_0
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->Q()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
    ...
    :cond_1
    invoke-static {}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->h()Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public final N(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
    .locals 1
...
.method public final Q()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
    .locals 10
    ...
    invoke-virtual {p0, v7}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->N(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
    ...
    invoke-virtual {v7, v0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->o(Ljava/lang/Object;)V

    return-object v7
.end method

.method public final R(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)Z
    .locals 9
    ...
    invoke-virtual {p1, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->o(Ljava/lang/Object;)V
...
.method public final W(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;II)V
    .locals 9
    ...
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->N(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
...
.method public final c(Lkotlinx/coroutines/scheduling/Task;)Z
    .locals 1
...
.method public close()V
    ...
    invoke-virtual {p0, v0, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->j0(J)V
...
.method public final d()I
    ...
    invoke-virtual {v5, v2}, Lkotlinx/coroutines/internal/ResizableAtomicArray;->b(I)Ljava/lang/Object;
    ...
    invoke-virtual {v6, v2, v5}, Lkotlinx/coroutines/internal/ResizableAtomicArray;->c(ILjava/lang/Object;)V
...
.method public final f(Ljava/lang/Runnable;Z)Lkotlinx/coroutines/scheduling/Task;
    .locals 3
    ...
    iput-boolean p2, p1, Lkotlinx/coroutines/scheduling/Task;->b:Z

    return-object p1

    :cond_0
    invoke-static {p1, v0, v1, p2}, Lkotlinx/coroutines/scheduling/TasksKt;->b(Ljava/lang/Runnable;JZ)Lkotlinx/coroutines/scheduling/Task;
...
.method public final j0(J)V
    ...
    :cond_0
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->o()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
    ...
    invoke-virtual {v4, v5}, Lkotlinx/coroutines/scheduling/WorkQueue;->j(Lkotlinx/coroutines/scheduling/GlobalQueue;)V
    ...
    invoke-virtual {v0, v2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->e(Z)Lkotlinx/coroutines/scheduling/Task;
    ...
    invoke-virtual {p1}, Lkotlinx/coroutines/internal/LockFreeTaskQueue;->e()Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->r(Lkotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState;)Z
...
.method public final o()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
    .locals 3
...
.method public final o0(J)V
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->L0()Z
...
.method public final r(Ljava/lang/Runnable;ZZ)V
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f(Ljava/lang/Runnable;Z)Lkotlinx/coroutines/scheduling/Task;

    move-result-object p1

    iget-boolean p2, p1, Lkotlinx/coroutines/scheduling/Task;->b:Z
    ...
    invoke-virtual {p0, v2, p1, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->x0(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;Lkotlinx/coroutines/scheduling/Task;Z)Lkotlinx/coroutines/scheduling/Task;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->c(Lkotlinx/coroutines/scheduling/Task;)Z
    ...
    invoke-virtual {p0, v0, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->o0(J)V

    goto :goto_2

    :cond_4
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->s0()V
...
.method public final s0()V
    ...
    invoke-static {p0, v2, v3, v0, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->A0(Lkotlinx/coroutines/scheduling/CoroutineScheduler;JILjava/lang/Object;)Z
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {v10}, Lkotlinx/coroutines/scheduling/WorkQueue;->i()I
...
.method public final x0(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;Lkotlinx/coroutines/scheduling/Task;Z)Lkotlinx/coroutines/scheduling/Task;
    .locals 2
    ...
    :cond_1
    iget-boolean v1, p2, Lkotlinx/coroutines/scheduling/Task;->b:Z
...
.method public final z0(J)Z
    ...
    invoke-static {v0, p1}, Lkotlin/ranges/RangesKt;->c(II)I
