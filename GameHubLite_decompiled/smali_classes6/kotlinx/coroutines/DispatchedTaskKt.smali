...
.method public static final a(Lkotlinx/coroutines/DispatchedTask;I)V
    ...
    iget-object p1, v0, Lkotlinx/coroutines/internal/DispatchedContinuation;->d:Lkotlinx/coroutines/CoroutineDispatcher;

    invoke-virtual {v0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lkotlin/coroutines/CoroutineContext;

    move-result-object v0

    invoke-static {p1, v0}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->d(Lkotlinx/coroutines/CoroutineDispatcher;Lkotlin/coroutines/CoroutineContext;)Z
...
.method public static final d(Lkotlinx/coroutines/DispatchedTask;Lkotlin/coroutines/Continuation;Z)V
    ...
    invoke-static {v1, v0}, Lkotlinx/coroutines/internal/ThreadContextKt;->i(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p2, v1, v0}, Lkotlinx/coroutines/CoroutineContextKt;->m(Lkotlin/coroutines/Continuation;Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)Lkotlinx/coroutines/UndispatchedCoroutine;
    ...
    invoke-virtual {p2}, Lkotlinx/coroutines/UndispatchedCoroutine;->B1()Z
...
.method public static final e(Lkotlinx/coroutines/DispatchedTask;)V
    ...
    invoke-virtual {v0}, Lkotlinx/coroutines/EventLoop;->F1()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {v0, p0}, Lkotlinx/coroutines/EventLoop;->B1(Lkotlinx/coroutines/DispatchedTask;)V
    ...
    invoke-virtual {v0, v1}, Lkotlinx/coroutines/EventLoop;->D1(Z)V
    ...
    :cond_1
    invoke-virtual {v0}, Lkotlinx/coroutines/EventLoop;->I1()Z
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lkotlinx/coroutines/EventLoop;->y1(Z)V
    ...
    :try_start_1
    invoke-virtual {p0, v2}, Lkotlinx/coroutines/DispatchedTask;->i(Ljava/lang/Throwable;)V
    :try_end_1
