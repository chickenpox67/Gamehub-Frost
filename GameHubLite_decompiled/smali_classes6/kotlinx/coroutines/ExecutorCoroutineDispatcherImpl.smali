...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;->d:Ljava/util/concurrent/Executor;

    invoke-virtual {p0}, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;->y1()Ljava/util/concurrent/Executor;
...
# virtual methods
.method public final A1(Ljava/util/concurrent/ScheduledExecutorService;Ljava/lang/Runnable;Lkotlin/coroutines/CoroutineContext;J)Ljava/util/concurrent/ScheduledFuture;
    .locals 1
    ...
    invoke-virtual {p0, p3, p1}, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;->z1(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/RejectedExecutionException;)V
...
.method public D(JLkotlinx/coroutines/CancellableContinuation;)V
    ...
    invoke-virtual/range {v3 .. v8}, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;->A1(Ljava/util/concurrent/ScheduledExecutorService;Ljava/lang/Runnable;Lkotlin/coroutines/CoroutineContext;J)Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-static {p3, p1}, Lkotlinx/coroutines/CancellableContinuationKt;->c(Lkotlinx/coroutines/CancellableContinuation;Lkotlinx/coroutines/CancelHandler;)V
...
.method public M0(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    :cond_2
    invoke-virtual {p0, p1, v0}, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;->z1(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/RejectedExecutionException;)V
...
.method public X(JLjava/lang/Runnable;Lkotlin/coroutines/CoroutineContext;)Lkotlinx/coroutines/DisposableHandle;
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lkotlinx/coroutines/DefaultExecutor;->X(JLjava/lang/Runnable;Lkotlin/coroutines/CoroutineContext;)Lkotlinx/coroutines/DisposableHandle;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1}, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;->y1()Ljava/util/concurrent/Executor;
...
.method public y1()Ljava/util/concurrent/Executor;
    ...
    iget-object v0, p0, Lkotlinx/coroutines/ExecutorCoroutineDispatcherImpl;->d:Ljava/util/concurrent/Executor;

    return-object v0
.end method

.method public final z1(Lkotlin/coroutines/CoroutineContext;Ljava/util/concurrent/RejectedExecutionException;)V
    .locals 1
