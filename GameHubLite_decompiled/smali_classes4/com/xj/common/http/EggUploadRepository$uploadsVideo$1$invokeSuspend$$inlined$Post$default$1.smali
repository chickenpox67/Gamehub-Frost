.class public final Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->$path:Ljava/lang/String;

    iput-object p2, p0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->$tag:Ljava/lang/Object;

    iput-object p3, p0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->$block:Lkotlin/jvm/functions/Function1;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;

    iget-object v1, p0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->$path:Ljava/lang/String;

    iget-object v2, p0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->$tag:Ljava/lang/Object;

    iget-object v3, p0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->$block:Lkotlin/jvm/functions/Function1;

    invoke-direct {v0, v1, v2, v3, p2}, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;-><init>(Ljava/lang/String;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->L$0:Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;

    move-result-object p1

    check-cast p1, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;

    sget-object p2, Lkotlin/Unit;->a:Lkotlin/Unit;

    invoke-virtual {p1, p2}, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v0, p0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->label:I

    if-nez v0, :cond_3

    invoke-static {p1}, Lkotlin/ResultKt;->b(Ljava/lang/Object;)V

    iget-object p1, p0, Lcom/xj/common/http/EggUploadRepository$uploadsVideo$1$invokeSuspend$$inlined$Post$default$1;->L$0:Ljava/lang/Object;
