...
.method public static varargs checkDataExist(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/Class;[Ljava/lang/String;)Z
    .locals 8
...
.method public static checkDb(Landroid/database/sqlite/SQLiteDatabase;)Landroid/database/sqlite/SQLiteDatabase;
    .locals 1
...
.method public static checkList(Ljava/lang/reflect/Field;)Z
    .locals 1
...
.method public static checkMap(Ljava/lang/reflect/Field;)Z
    .locals 4
...
.method public static checkOrCreateTable(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/Class;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static clean(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/Class;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getAllNotIgnoreField(Ljava/lang/Class;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getColumnTypeByFieldName(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/String;
    .locals 2
...
.method public static getColumns(Ljava/lang/Class;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getPrimaryName(Ljava/lang/Class;)Ljava/lang/String;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static isDefault(Ljava/lang/reflect/Field;)Z
    .locals 1
...
.method public static isMany(Ljava/lang/reflect/Field;)Z
    .locals 1
...
.method public static isNoNull(Ljava/lang/reflect/Field;)Z
    .locals 1
...
.method public static isOne(Ljava/lang/reflect/Field;)Z
    .locals 1
...
.method public static isPrimary(Ljava/lang/reflect/Field;)Z
    .locals 1
...
.method public static list2Str(Lcom/arialyy/aria/orm/DbEntity;Ljava/lang/reflect/Field;)Ljava/lang/String;
    .locals 1
...
.method public static str2List(Ljava/lang/String;Ljava/lang/reflect/Field;)Ljava/util/List;
    .locals 4
...
.method public static str2Map(Ljava/lang/String;)Ljava/util/Map;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static tableExists(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/Class;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static tableExists(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    .line 8
    invoke-static {v1}, Lcom/arialyy/aria/orm/SqlUtil;->closeCursor(Landroid/database/Cursor;)V
