...
.method public constructor <init>(Ljava/lang/Class;I)V
    ...
    check-cast p1, Lin/dragonbra/javasteam/base/IGCSerializableMessage;

    iput-object p1, p0, Lin/dragonbra/javasteam/base/ClientGCMsg;->body:Lin/dragonbra/javasteam/base/IGCSerializableMessage;
    :try_end_0
    ...
    .line 4
    :goto_0
    sget-object p2, Lin/dragonbra/javasteam/base/ClientGCMsg;->logger:Lin/dragonbra/javasteam/util/log/Logger;

    invoke-virtual {p2, p1}, Lin/dragonbra/javasteam/util/log/Logger;->debug(Ljava/lang/Throwable;)V

    .line 5
    :goto_1
    iget-object p1, p0, Lin/dragonbra/javasteam/base/ClientGCMsg;->body:Lin/dragonbra/javasteam/base/IGCSerializableMessage;

    invoke-interface {p1}, Lin/dragonbra/javasteam/base/IGCSerializableMessage;->getEMsg()I

    move-result p1

    iput p1, p0, Lin/dragonbra/javasteam/base/ClientGCMsg;->msgType:I
...
.method public constructor <init>(Ljava/lang/Class;Lin/dragonbra/javasteam/base/GCMsgBase;I)V
    ...
    check-cast p1, Lin/dragonbra/javasteam/generated/MsgGCHdr;
    ...
    check-cast p2, Lin/dragonbra/javasteam/generated/MsgGCHdr;

    invoke-virtual {p2}, Lin/dragonbra/javasteam/generated/MsgGCHdr;->getSourceJobID()J

    move-result-wide p2

    invoke-virtual {p1, p2, p3}, Lin/dragonbra/javasteam/generated/MsgGCHdr;->setTargetJobID(J)V
...
.method public constructor <init>(Ljava/lang/Class;Lin/dragonbra/javasteam/base/IPacketGCMsg;)V
    ...
    const-string p1, "> used for proto message!"
    ...
    invoke-virtual {p0, p1}, Lin/dragonbra/javasteam/base/ClientGCMsg;->deserialize([B)V
