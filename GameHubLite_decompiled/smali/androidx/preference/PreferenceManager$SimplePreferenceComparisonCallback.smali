...
.method public a(Landroidx/preference/Preference;Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {p1}, Landroidx/preference/Preference;->F0()Z
    ...
    :cond_2
    invoke-virtual {p1}, Landroidx/preference/Preference;->D()Ljava/lang/CharSequence;
    ...
    :cond_3
    invoke-virtual {p1}, Landroidx/preference/Preference;->p()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {p2}, Landroidx/preference/Preference;->p()Landroid/graphics/drawable/Drawable;
    ...
    :cond_5
    invoke-virtual {p1}, Landroidx/preference/Preference;->J()Z

    move-result v0

    invoke-virtual {p2}, Landroidx/preference/Preference;->J()Z
    ...
    invoke-virtual {p2}, Landroidx/preference/Preference;->L()Z
...
.method public b(Landroidx/preference/Preference;Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {p2}, Landroidx/preference/Preference;->q()J
