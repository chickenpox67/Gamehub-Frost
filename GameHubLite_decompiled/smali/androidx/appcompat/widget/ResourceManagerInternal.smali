...
.method public static declared-synchronized k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/ResourceManagerInternal$ColorFilterLruCache;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/ResourceManagerInternal$ColorFilterLruCache;->d(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static o(Landroidx/appcompat/widget/ResourceManagerInternal;)V
    .locals 0
...
.method public static v(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/TintInfo;[I)V
    .locals 2
...
.method public declared-synchronized j(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ResourceManagerInternal;->c(Landroid/content/Context;)V

    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2}, Landroidx/collection/SparseArrayCompat;->d(I)Ljava/lang/Object;
...
.method public final q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p2}, Landroidx/collection/SparseArrayCompat;->d(I)Ljava/lang/Object;
...
.method public declared-synchronized s(Landroid/content/Context;Landroidx/appcompat/widget/VectorEnabledTintResources;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p3}, Landroidx/appcompat/widget/ResourceManagerInternal;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/ResourceManagerInternal;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
