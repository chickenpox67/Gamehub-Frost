...
.method public a(Landroid/graphics/Canvas;Ljava/util/HashMap;II)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->j(Landroid/graphics/Canvas;Landroidx/constraintlayout/motion/widget/MotionController;)V
...
.method public b(Landroid/graphics/Canvas;IILandroidx/constraintlayout/motion/widget/MotionController;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->d(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->g(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->e(Landroid/graphics/Canvas;)V

    :cond_2
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->c(Landroid/graphics/Canvas;)V

    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->k(Landroid/graphics/Canvas;IILandroidx/constraintlayout/motion/widget/MotionController;)V
...
.method public final k(Landroid/graphics/Canvas;IILandroidx/constraintlayout/motion/widget/MotionController;)V
    ...
    invoke-virtual {v6, v7, v0, v1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->h(Landroid/graphics/Canvas;FF)V
    ...
    invoke-virtual {v6, v7, v0, v1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->f(Landroid/graphics/Canvas;FF)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->i(Landroid/graphics/Canvas;FFII)V
    ...
    invoke-virtual {v6, v7, v5, v4}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->h(Landroid/graphics/Canvas;FF)V
    ...
    invoke-virtual {v6, v7, v5, v4}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->f(Landroid/graphics/Canvas;FF)V
