...
.field public final e:Landroidx/emoji2/text/EmojiCompat$CompatInternal;

.field public final f:Landroidx/emoji2/text/EmojiCompat$MetadataRepoLoader;

.field public final g:Landroidx/emoji2/text/EmojiCompat$SpanFactory;
...
.field public final n:Landroidx/emoji2/text/EmojiCompat$GlyphChecker;
...
.method public constructor <init>(Landroidx/emoji2/text/EmojiCompat$Config;)V
    ...
    iput-object v0, p0, Landroidx/emoji2/text/EmojiCompat;->n:Landroidx/emoji2/text/EmojiCompat$GlyphChecker;
    ...
    :goto_0
    iput-object v1, p0, Landroidx/emoji2/text/EmojiCompat;->g:Landroidx/emoji2/text/EmojiCompat$SpanFactory;
    ...
    invoke-virtual {p0}, Landroidx/emoji2/text/EmojiCompat;->n()V

    return-void
.end method

.method public static synthetic a(Landroidx/emoji2/text/EmojiCompat;)Landroidx/emoji2/text/EmojiCompat$SpanFactory;
    .locals 0

    iget-object p0, p0, Landroidx/emoji2/text/EmojiCompat;->g:Landroidx/emoji2/text/EmojiCompat$SpanFactory;

    return-object p0
.end method

.method public static synthetic b(Landroidx/emoji2/text/EmojiCompat;)Landroidx/emoji2/text/EmojiCompat$GlyphChecker;
    .locals 0

    iget-object p0, p0, Landroidx/emoji2/text/EmojiCompat;->n:Landroidx/emoji2/text/EmojiCompat$GlyphChecker;
...
.method public static i(Landroidx/emoji2/text/EmojiCompat$Config;)Landroidx/emoji2/text/EmojiCompat;
    .locals 2
...
.method public d(Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {p0}, Landroidx/emoji2/text/EmojiCompat;->l()Z
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/emoji2/text/EmojiCompat$CompatInternal;->a(Ljava/lang/CharSequence;I)I
...
.method public m()V
    ...
    invoke-virtual {v0}, Landroidx/emoji2/text/EmojiCompat$CompatInternal;->b()V
...
.method public q(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_0
    invoke-virtual {p0, p1, v0, v1}, Landroidx/emoji2/text/EmojiCompat;->r(Ljava/lang/CharSequence;II)Ljava/lang/CharSequence;
...
.method public r(Ljava/lang/CharSequence;II)Ljava/lang/CharSequence;
    .locals 1

    const v0, 0x7fffffff

    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/emoji2/text/EmojiCompat;->s(Ljava/lang/CharSequence;III)Ljava/lang/CharSequence;
...
.method public s(Ljava/lang/CharSequence;III)Ljava/lang/CharSequence;
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/emoji2/text/EmojiCompat;->t(Ljava/lang/CharSequence;IIII)Ljava/lang/CharSequence;
...
.method public t(Ljava/lang/CharSequence;IIII)Ljava/lang/CharSequence;
    .locals 7
    ...
    invoke-virtual/range {v1 .. v6}, Landroidx/emoji2/text/EmojiCompat$CompatInternal;->c(Ljava/lang/CharSequence;IIIZ)Ljava/lang/CharSequence;
...
.method public u(Landroidx/emoji2/text/EmojiCompat$InitCallback;)V
    .locals 3
...
.method public v(Landroidx/emoji2/text/EmojiCompat$InitCallback;)V
    .locals 1
...
.method public w(Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/emoji2/text/EmojiCompat$CompatInternal;->d(Landroid/view/inputmethod/EditorInfo;)V
