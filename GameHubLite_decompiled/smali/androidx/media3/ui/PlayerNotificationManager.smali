...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ILandroidx/media3/ui/PlayerNotificationManager$MediaDescriptionAdapter;Landroidx/media3/ui/PlayerNotificationManager$NotificationListener;Landroidx/media3/ui/PlayerNotificationManager$CustomActionReceiver;IIIIIIIILjava/lang/String;)V
    ...
    invoke-static {v11}, Landroidx/core/app/NotificationManagerCompat;->d(Landroid/content/Context;)Landroidx/core/app/NotificationManagerCompat;
...
.method private static setLargeIcon(Landroidx/core/app/NotificationCompat$Builder;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/core/app/NotificationCompat$Builder;->A(Landroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$Builder;
...
.method private startOrUpdateNotification(Landroidx/media3/common/Player;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v1, v2, p1}, Landroidx/core/app/NotificationManagerCompat;->f(ILandroid/app/Notification;)V
...
.method public createNotification(Landroidx/media3/common/Player;Landroidx/core/app/NotificationCompat$Builder;ZLandroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p2, v6}, Landroidx/core/app/NotificationCompat$Builder;->b(Landroidx/core/app/NotificationCompat$Action;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p2, v6}, Landroidx/core/app/NotificationCompat$Builder;->J(Landroidx/core/app/NotificationCompat$Style;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v6, v0}, Landroidx/media/app/NotificationCompat$MediaStyle;->j([I)Landroidx/media/app/NotificationCompat$MediaStyle;

    xor-int/lit8 v0, p3, 0x1

    invoke-virtual {v6, v0}, Landroidx/media/app/NotificationCompat$MediaStyle;->k(Z)Landroidx/media/app/NotificationCompat$MediaStyle;

    iget-object v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->dismissPendingIntent:Landroid/app/PendingIntent;

    invoke-virtual {v6, v0}, Landroidx/media/app/NotificationCompat$MediaStyle;->h(Landroid/app/PendingIntent;)Landroidx/media/app/NotificationCompat$MediaStyle;
    ...
    invoke-virtual {p2, v0}, Landroidx/core/app/NotificationCompat$Builder;->w(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$Builder;

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->badgeIconType:I

    invoke-virtual {p2, v0}, Landroidx/core/app/NotificationCompat$Builder;->n(I)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object v0

    invoke-virtual {v0, p3}, Landroidx/core/app/NotificationCompat$Builder;->C(Z)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object p3

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->color:I

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$Builder;->q(I)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object p3

    iget-boolean v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->colorized:Z

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$Builder;->r(Z)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object p3

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->smallIconResourceId:I

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$Builder;->H(I)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object p3

    iget v0, p0, Landroidx/media3/ui/PlayerNotificationManager;->visibility:I

    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$Builder;->O(I)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p3, v0}, Landroidx/core/app/NotificationCompat$Builder;->v(I)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p2, v3, v4}, Landroidx/core/app/NotificationCompat$Builder;->P(J)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object p3

    invoke-virtual {p3, v2}, Landroidx/core/app/NotificationCompat$Builder;->G(Z)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object p3

    invoke-virtual {p3, v2}, Landroidx/core/app/NotificationCompat$Builder;->M(Z)Landroidx/core/app/NotificationCompat$Builder;

    goto :goto_4

    :cond_7
    invoke-virtual {p2, v4}, Landroidx/core/app/NotificationCompat$Builder;->G(Z)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object p3

    invoke-virtual {p3, v4}, Landroidx/core/app/NotificationCompat$Builder;->M(Z)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p2, p3}, Landroidx/core/app/NotificationCompat$Builder;->u(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p2, p3}, Landroidx/core/app/NotificationCompat$Builder;->t(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p2, p3}, Landroidx/core/app/NotificationCompat$Builder;->K(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p2, p1}, Landroidx/core/app/NotificationCompat$Builder;->s(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$Builder;

    iget-object p1, p0, Landroidx/media3/ui/PlayerNotificationManager;->groupKey:Ljava/lang/String;

    if-eqz p1, :cond_9

    invoke-virtual {p2, p1}, Landroidx/core/app/NotificationCompat$Builder;->z(Ljava/lang/String;)Landroidx/core/app/NotificationCompat$Builder;

    :cond_9
    invoke-virtual {p2, v2}, Landroidx/core/app/NotificationCompat$Builder;->D(Z)Landroidx/core/app/NotificationCompat$Builder;
