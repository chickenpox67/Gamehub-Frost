...
.method public constructor <init>(Landroid/net/http/HttpEngine;Ljava/util/concurrent/Executor;IIIZZLjava/lang/String;Landroidx/media3/datasource/HttpDataSource$RequestProperties;Lcom/google/common/base/Predicate;Z)V
    ...
    invoke-static {p1}, Landroidx/media3/datasource/t;->a(Ljava/lang/Object;)Landroid/net/http/HttpEngine;
...
.method private buildRequestBuilder(Landroidx/media3/datasource/DataSpec;Landroid/net/http/UrlRequest$Callback;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v0}, Landroidx/media3/datasource/v;->a(Landroid/net/http/UrlRequest$Builder;I)Landroid/net/http/UrlRequest$Builder;

    move-result-object p2

    const/4 v0, 0x1

    invoke-static {p2, v0}, Landroidx/media3/datasource/w;->a(Landroid/net/http/UrlRequest$Builder;Z)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v3, v2}, Landroidx/media3/datasource/x;->a(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v1, v0}, Landroidx/media3/datasource/x;->a(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
    ...
    invoke-static {p2, v0}, Landroidx/media3/datasource/y;->a(Landroid/net/http/UrlRequest$Builder;Ljava/lang/String;)Landroid/net/http/UrlRequest$Builder;
...
.method private buildRequestWrapper(Landroidx/media3/datasource/DataSpec;)Landroidx/media3/datasource/HttpEngineDataSource$UrlRequestWrapper;
    ...
    invoke-static {p1}, Landroidx/media3/datasource/l;->a(Landroid/net/http/UrlRequest$Builder;)Landroid/net/http/UrlRequest;
...
.method private static isCompressed(Landroid/net/http/UrlResponseInfo;)Z
    ...
    invoke-static {p0}, Landroidx/media3/datasource/q;->a(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;
...
.method public getResponseCode()I
    ...
    invoke-static {v0}, Landroidx/media3/datasource/j;->a(Landroid/net/http/UrlResponseInfo;)I
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    :cond_0
    invoke-static {v0}, Landroidx/media3/datasource/q;->a(Landroid/net/http/UrlResponseInfo;)Landroid/net/http/HeaderBlock;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/datasource/m;->a(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
...
.method public getUri()Landroid/net/Uri;
    ...
    :cond_0
    invoke-static {v0}, Landroidx/media3/datasource/p;->a(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    invoke-static {v0}, Landroidx/media3/datasource/n;->a(Ljava/lang/Object;)Landroid/net/http/UrlResponseInfo;
    ...
    invoke-static {v4}, Landroidx/media3/datasource/m;->a(Landroid/net/http/HeaderBlock;)Ljava/util/Map;
    ...
    invoke-static {v0}, Landroidx/media3/datasource/o;->a(Landroid/net/http/UrlResponseInfo;)Ljava/lang/String;
