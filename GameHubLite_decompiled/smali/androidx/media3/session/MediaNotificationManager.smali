...
.method public constructor <init>(Landroidx/media3/session/MediaSessionService;Landroidx/media3/session/MediaNotification$Provider;Landroidx/media3/session/MediaNotification$ActionFactory;)V
    ...
    new-instance p3, Landroidx/media3/session/p7;

    invoke-direct {p3, p2}, Landroidx/media3/session/p7;-><init>(Landroid/os/Handler;)V
...
.method public static synthetic b(Landroidx/media3/session/MediaNotificationManager;Landroidx/media3/session/MediaSession;Landroidx/media3/session/MediaNotification;Z)V
    .locals 0
...
.method public static synthetic d(Landroidx/media3/session/MediaNotificationManager;Landroidx/media3/session/MediaSession;Ljava/lang/String;Landroid/os/Bundle;Landroidx/media3/session/MediaController;)V
    .locals 0
...
.method public static synthetic e(Landroidx/media3/session/MediaNotificationManager;Landroidx/media3/session/MediaSession;Lcom/google/common/collect/ImmutableList;Landroidx/media3/session/MediaNotification$Provider$Callback;Z)V
    .locals 0
...
.method public static synthetic h(Landroidx/media3/session/MediaNotificationManager;Lcom/google/common/util/concurrent/ListenableFuture;Landroidx/media3/session/MediaNotificationManager$MediaControllerListener;Landroidx/media3/session/MediaSession;)V
    .locals 0
...
.method private synthetic lambda$onCustomAction$3(Landroidx/media3/session/MediaSession;Ljava/lang/String;Landroid/os/Bundle;Landroidx/media3/session/MediaController;)V
    ...
    invoke-direct {v0, p0, p4, p2, p3}, Landroidx/media3/session/o7;-><init>(Landroidx/media3/session/MediaNotificationManager;Landroidx/media3/session/MediaController;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method private synthetic lambda$updateNotification$5(ILandroidx/media3/session/MediaSession;Landroidx/media3/session/MediaNotification;)V
    ...
    new-instance v1, Landroidx/media3/session/n7;

    invoke-direct {v1, p0, p1, p2, p3}, Landroidx/media3/session/n7;-><init>(Landroidx/media3/session/MediaNotificationManager;ILandroidx/media3/session/MediaSession;Landroidx/media3/session/MediaNotification;)V
...
.method private synthetic lambda$updateNotification$7(Landroidx/media3/session/MediaSession;Lcom/google/common/collect/ImmutableList;Landroidx/media3/session/MediaNotification$Provider$Callback;Z)V
    ...
    invoke-direct {v0, p0, p1, p2, p4}, Landroidx/media3/session/q7;-><init>(Landroidx/media3/session/MediaNotificationManager;Landroidx/media3/session/MediaSession;Landroidx/media3/session/MediaNotification;Z)V
...
.method private updateNotificationInternal(Landroidx/media3/session/MediaSession;Landroidx/media3/session/MediaNotification;Z)V
    ...
    invoke-virtual {p1, p3, p2}, Landroidx/core/app/NotificationManagerCompat;->f(ILandroid/app/Notification;)V
...
.method public addSession(Landroidx/media3/session/MediaSession;)V
    ...
    new-instance v2, Landroidx/media3/session/u7;

    invoke-direct {v2, p0, v1, v0, p1}, Landroidx/media3/session/u7;-><init>(Landroidx/media3/session/MediaNotificationManager;Lcom/google/common/util/concurrent/ListenableFuture;Landroidx/media3/session/MediaNotificationManager$MediaControllerListener;Landroidx/media3/session/MediaSession;)V
...
.method public onCustomAction(Landroidx/media3/session/MediaSession;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    new-instance v7, Landroidx/media3/session/r7;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/media3/session/r7;-><init>(Landroidx/media3/session/MediaNotificationManager;Landroidx/media3/session/MediaSession;Ljava/lang/String;Landroid/os/Bundle;Landroidx/media3/session/MediaController;)V
...
.method public updateNotification(Landroidx/media3/session/MediaSession;Z)V
    ...
    :goto_2
    new-instance v6, Landroidx/media3/session/s7;

    invoke-direct {v6, p0, v0, p1}, Landroidx/media3/session/s7;-><init>(Landroidx/media3/session/MediaNotificationManager;ILandroidx/media3/session/MediaSession;)V
    ...
    new-instance v1, Landroidx/media3/session/t7;
    ...
    invoke-direct/range {v2 .. v7}, Landroidx/media3/session/t7;-><init>(Landroidx/media3/session/MediaNotificationManager;Landroidx/media3/session/MediaSession;Lcom/google/common/collect/ImmutableList;Landroidx/media3/session/MediaNotification$Provider$Callback;Z)V
