...
.method private final f(Landroidx/room/Transactor$SQLiteTransactionType;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p3}, Landroidx/room/driver/SupportSQLiteConnection;->a()Landroidx/sqlite/db/SupportSQLiteDatabase;

    move-result-object p3

    invoke-interface {p3}, Landroidx/sqlite/db/SupportSQLiteDatabase;->m1()Z
    ...
    :cond_3
    sget-object v2, Landroidx/room/driver/SupportSQLitePooledConnection$WhenMappings;->a:[I
    ...
    invoke-interface {p3}, Landroidx/sqlite/db/SupportSQLiteDatabase;->p()V
    ...
    :cond_6
    invoke-interface {p3}, Landroidx/sqlite/db/SupportSQLiteDatabase;->c0()V
    ...
    :goto_2
    :try_start_2
    invoke-interface {p1}, Landroidx/sqlite/db/SupportSQLiteDatabase;->C0()V
    :try_end_2
    .catch Landroidx/room/coroutines/ConnectionPool$RollbackException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    invoke-interface {p1}, Landroidx/sqlite/db/SupportSQLiteDatabase;->H0()V

    invoke-interface {p1}, Landroidx/sqlite/db/SupportSQLiteDatabase;->m1()Z
...
.method public b(Ljava/lang/String;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p3, p1}, Landroidx/room/driver/SupportSQLiteConnection;->b(Ljava/lang/String;)Landroidx/room/driver/SupportSQLiteStatement;
